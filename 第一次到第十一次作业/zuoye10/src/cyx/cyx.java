...
public class lw1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while (rs.next()) {
							out.println("{");
							out.println("\"sxh\":\""+rs.getString("sxh")+"\",");
							out.println("\"sname\":\""+rs.getString("sname")+"\",");
							out.println("\"szf\":\""+rs.getInt("szf")+"\","); 
							out.println("\"szy1\":\""+rs.getInt("szy1")+"\",");
							out.println("\"szy2\":\""+rs.getInt("szy2")+"\",");
							out.println("\"szy3\":\""+rs.getInt("szy3")+"\"");
							out.println("},");
						}
						out.println("]");
						rs.close();
