    ...
    questionnaireArray: [
      {
        ...
        "content": {
          ...
          "options":
            [
              { "id": 1, "name": "每周都看", "isSelected": false },
              { "id": 2, "name": "偶尔看", "isSelected": false },
              { "id": 3, "name": "几乎不看", "isSelected": false }
            ]
        }
      },
      {
        ...
        "content": {
          ...
          "options":
            [
              ...
              { "id": 3, "name": "一般不玩", "isSelected": false }
            ]
        }
      },
      {
        "type": "SAQ",
        "content": {
          "description": "你最喜欢的食物口味是?",
          "options":
            [
              { "id": 1, "name": "甜", "isSelected": false },
              { "id": 2, "name": "咸", "isSelected": false },
              { "id": 3, "name": "辣", "isSelected": false },
